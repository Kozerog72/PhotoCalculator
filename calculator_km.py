...
def calculator2():
    calc2 = ((int(e4.get()) / 1000) * ((float(e6.get()) / 1000) + (float(e5.get()))) / (float(e6.get()) / 1000)) / 1000
...
b5 = Label(frame4, text='Enter True size of the Object in meter:', width=35, pady=5, bg="#FFDC85")
...
calculate2 = Button(frame4, text="CALCULATE >> (result - km):", width=36, pady=5, fg="blue", command=calculator2)
