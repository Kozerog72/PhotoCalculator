...
def calculator2():
    calc2 = ((int(e4.get()) / 1000) * ((float(e6.get()) / 1000) + (float(e5.get()))) / (float(e6.get()) / 1000))
...
calculate2 = Button(frame4, text="CALCULATE >> (meter):", width=36, pady=5, fg="blue", command=calculator2)
